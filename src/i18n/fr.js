export default {
  ...
  strings: {
    ...
    helpText:
      ...
      "Vos réglages (noms, minutes, langue et thème) sont conservés dans votre navigateur via localStorage, pas via des cookies. Rien ne quitte votre appareil : ni compte, ni serveur, ni suivi.",
